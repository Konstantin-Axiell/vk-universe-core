<?php
//By UnFox
	$get = json_decode(file_get_contents("https://vkue.unfox.ru/update/Update.php?version=".urlencode($version)),1);	
	...
	foreach ($get['hashes'] as $file => $hash) {
 	...
 	if(file_exists('VK-UNIVERSE/update.zip')){unlink("VK-UNIVERSE/update.zip");}
?>