...
class VKUE {
    public function __construct($params) {
    	...
    	$this->version = "1.2.6.4B";//Текущая версия ядра
    	$this->vbuild = "31-01-2018";//Текущая дата сборки
    	global $argv;
    ...
    function msg($data){
		$msg = array(
			...
			$user = get('https://api.vk.com/method/users.get?v=5.72&user_id='.$msg['from_id']);
